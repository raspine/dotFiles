...
awesome_icon:buttons(awful.util.table.join( awful.button({ }, 1, function() awful.util.spawn("gvim /home/jsc/homescripts/rc.lua") end)))
--}}}

--{{{ vim config
vim_icon = wibox.widget.imagebox()
vim_icon:set_image("/home/jsc/.config/awesome/lain/icons/vim.png")
vim_icon:buttons(awful.util.table.join( awful.button({ }, 1, function() awful.util.spawn("gvim /home/jsc/homescripts/.vimrc") end)))
--}}}
...
for s = 1, screen.count() do
  ...
  right_layout:add(awesome_icon)
  right_layout:add(vim_icon)
